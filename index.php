            ...
            <div id="connect">
                ...
                <ul class="layout center justified">
                    <li class="layout center-center">
                        <a href="<?php echo get_option('twitter'); ?>" title="Follow on Twitter" target="_blank">
                    ...
                    <li class="layout center-center">
                        <a href=<?php echo get_option('instagram'); ?>" title="Follow on Instagram" target="_blank">
                    ...
                    <li class="layout center-center">
                        <a href="<?php echo get_option('facebook'); ?>" title="Follow on Facebook" target="_blank">
